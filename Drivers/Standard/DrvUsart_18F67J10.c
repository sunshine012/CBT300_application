...
//
//
volatile UINT8 DrvUsartGetStatus(void)
{
   UINT8 Status;
...
//
//
volatile UINT16 DrvUsart2Read( void* pBuffer, UINT16 MaxCounts)
{
   UINT16   Count = 0;
   UINT8    Char;
...
//
//
volatile UINT16 DrvUsartGetNumberOfBytesAvailable(void)
{
   UINT16   NumOfBytes;
   UINT16   WIndex;
...
{                                      //get the status
   INT32          NumOfBytes;
   UINT16         BytesAvailable, BytesRead;
   volatile UINT8 Status;

   Status = DrvUsartGetStatus();
   BytesAvailable = DrvUsartGetNumberOfBytesAvailable();
