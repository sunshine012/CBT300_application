...
extern volatile UINT8 DrvUsartGetStatus(void);
extern volatile UINT16 DrvUsart2Read( void* pBuffer, UINT16 MaxCounts);
extern volatile UINT16 DrvUsartGetNumberOfBytesAvailable(void);
extern volatile UINT16 DrvUsart2GetMessageLength(void);
extern volatile UINT8 AppCheckSerialPort( CHAR* pBuffer, UINT8 mode);
//
// End of include file.
//
