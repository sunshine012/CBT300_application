...
void DrvIntIsrHigh( void );

#ifdef USE_BOOT_LOADER
#pragma code high_vector=APP_HIGH_VECTOR_ADDRESS
#else
#pragma code high_vector=0x08
#endif

void DrvIntVectorHigh( void )
{
   _asm GOTO DrvIntIsrHigh _endasm
}

#pragma code
#pragma interrupt DrvIntIsrHigh
...
void DrvIntIsrLow( void );

#ifdef USE_BOOT_LOADER
#pragma code low_vector=APP_LOW_VECTOR_ADDRESS
#else
#pragma code low_vector=0x18
#endif

void DrvIntVectorLow( void )
{
   _asm GOTO DrvIntIsrLow _endasm
}

#pragma code
#pragma interruptlow DrvIntIsrLow
